...
describe('Circularity', function() {
    ...
    before(function(done) {
        init(window);
        opspark.makeRunner();
        runner = window.opspark.runner;
        circle = runner.circle;
        circles = runner.circles;
        update = runner.update;
        drawCircle = runner.drawCircle;
        checkCircleBounds = runner.checkCircleBounds;
        done();
    ...
    describe('TODO 6: Call checkCircleBounds on each of your circles', function() {
        ...
        it('should call checkCircleBounds 5 times', function() {
            update();
